...
// initialization of socketio coneection
const socket = io("/");
...
const switchForSCcreenSharingButton = document.getElementById('screen_sharing_button');
switchForSCcreenSharingButton.addEventListener('click', () =>{
...
startRecordingButton.addEventListener('click',()=>{
   // console.log('@@@@');
    ...
    //console.log("@@@@ recording button", recordingButtons)
